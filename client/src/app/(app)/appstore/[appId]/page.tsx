...
import { GraduationCap, MessageSquare, ShoppingCart, Star } from 'lucide-react'
	...
	return (
		<section className="grid grid-rows-2 gap-20 md:grid-cols-5 md:grid-rows-1 md:gap-[8%]">
			...
			<div className="flex h-full w-full flex-col gap-10 md:col-span-2">
				<div className="flex h-fit flex-col items-center justify-center gap-10 rounded-lg p-4">
				...
				<div className="du flex justify-center gap-2">
				...
				<div className="rounded-lg bg-white/10 p-6">
					...
					<div className="flex flex-col justify-start space-y-6">
						<p className="text-sm font-bold text-primary-b-300">
							La compra incluye
						</p>
						...
						<p>
							Actualizaciones gratuitas: Disfrutá de mejoras y nuevas
							funcionalidades sin costo adicional.
						</p>
						<p>
							Soporte técnico dedicado: Asistencia personalizada para resolver
							cualquier duda o inconveniente que tengas.
						</p>
						<p>
							Guías y tutoriales: Materiales de apoyo que te ayudarán a
							aprovechar al máximo todas las características de la app.
						</p>
					</div>
				</div>
				...
				<div className="mt-10 flex flex-col items-center space-y-6 rounded-lg border-2 border-primary-b-300 p-6">
					<p className="text-lg font-semibold">
						Con la compra de esta app tiene un 50% OFF en la compra del cursos:
						Gestión de inventarios con AppSheet
					</p>
					<ApplicationCard app={app} setProductSelected={SetAppSelected} />
				</div>
			</div>
			<div className="my-10 w-screen space-y-10">
				...
				<div className="flex w-fit flex-col flex-wrap items-center justify-between gap-4 lg:flex-row">
					<ApplicationCard app={app} setProductSelected={SetAppSelected} />
					<ApplicationCard app={app} setProductSelected={SetAppSelected} />
					<ApplicationCard app={app} setProductSelected={SetAppSelected} />
					<ApplicationCard app={app} setProductSelected={SetAppSelected} />
