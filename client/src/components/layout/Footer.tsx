...
export default function Footer() {
	...
	return (
		<footer className="w-full bg-custom-gradient pt-14 text-white">
			<div className="container grid grid-cols-1 md:grid-cols-4 mx-auto px-8  gap-4 mb-28">
				<div>
				...
				<div>
					...
					<ul className="flex space-x-4">
						<li>
							<Link href={'#'}>
								<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="white" stroke="currentColor" strokeWidth="0" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-facebook"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z" /></svg>
							</Link>
						</li>
						<li>
							<Link href={'#'}>
			...
			<div className='flex flex-row justify-center items-center border-t-2 border-t-zinc-600 py-4 '>
